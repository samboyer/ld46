...
function control_player()
  ...
  if (not isintro and lmbdown and player.weapon_cooldown == 0 and wateranimframes==0) then
    add_bullet()
...
function show_effect_text(text, override, playsfx)
  if((gameover or isintro) and not override) return
...

