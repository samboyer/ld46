...
function start_game(frommenu)
  ...
  if isintro then
    ...
    if(not flag_thomas) music(8,500)
    run_timer=false
  else
    if(not flag_thomas) music(0,0,1)
    run_timer=true
  end
...
flag_thomas = false
seq = {2,2,3,3,0,1,0,1,4,5}
seq_i=1

function _update()
  if btnp(seq[seq_i]) then
    seq_i+=1
    if seq_i==11 then
      flag_thomas = true
      music(24)
    ...
    if(btnp(0)or btnp(1)or btnp(2)or btnp(3)or btnp(4)or btnp(5)) seq_i = 1
  end
  ...
  if gamerunning then
    ...
    if not isintro then
      score += 0.2
       if(not flag_thomas and (stat(24)%2==0 and stat(26)==0) or stat(24)==-1) music(desiredmusic,0,1) --if current music id is even numbered and we're at step 0, or no music is playing,
    end
...
function draw_player()
  ...
  if(flag_thomas) player.sprite = 79
...
function _draw()
  if not (gamerunning or gameover) then --MENU
    ...
    palt(14)
    spr(flag_thomas and 79 or 85, 60, 120)
    palt()
...

